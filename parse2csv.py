...
path = str(os.getcwd())+'/D/{}'.format(host)
...
def main():
    ...
    '''
        ...
        For-loop for all file lists per day per node:

        ex) 20220621000000 ~ 20220621235955
        This function gets all features from a text file,
        readline and puts all values into csv files, accordingly.
   ...
   '''
    ...
    df.to_csv(str(os.getcwd())+'/res/'+host+'/'+str(_)[2:8]+'data.csv', index=False)
